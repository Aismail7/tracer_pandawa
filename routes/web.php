...
Route::group(['namespace' => 'mahasiswa','prefix' => 'mahasiswa','middleware' => 'mahasiswa'], function() {
    ...
    Route::resource('alumni','AlumniCtrl');
    Route::get('alumni/{id}','AlumniCtrl@index');

    Route::resource('tracer','TracerCtrl');
    Route::get('tracer/{id}','TracerCtrl@index');
    // Route::get('alumni/{id}/calonpeserta','KrsCtrl@show')->name('krs.calonpeserta');
    //  Route::resource('mahasiswa','MhsCtrl');
