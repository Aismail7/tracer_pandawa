      ...
      <div class="span12">
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-book"></i> </span>
	    	...
	    	<form id="form-wizard" class="form-horizontal" action="{{route('alumni.update',$mahasiswa->id)}}" method="POST">
	    	{{ csrf_field() }}
	    	...
	    	<div id="form-wizard-1" class="step">
               ...
               <div class="control-group">
                  ...
                  <div class="control-group">
	                      <label class="control-label" class="form-group @if($errors->has('jenis')) has-error @endif">Jenis Kelamin</label>
	                       <div class="controls">
                 ...
                 <div class="control-group">
	                    ...
	                    <span id="helpBlock2" class="help-block">{{$errors->first('hp1')}}</span>
                              ...
                              <div class="control-group">
	                     <label class="control-label" class="form-group @if($errors->has('hp2')) has-error @endif">Hp 2</label>
  						 <div class="controls">
					...
					<a href="{{ route('alumni.index') }}" class="btn btn-danger">Batal</a>
					<div id="status"></div>
				</div>
